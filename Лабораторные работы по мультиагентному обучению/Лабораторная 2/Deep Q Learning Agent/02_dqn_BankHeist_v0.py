...
class Agent:
    ...
    def play_step(self, net, epsilon=0.0, device=device_available):
        done_reward = None
...
def calc_loss(batch, net, tgt_net, device=device_available):
...
if __name__ == "__main__":
    ...
    while True:#len(total_rewards)<=250
        frame_idx += 1
